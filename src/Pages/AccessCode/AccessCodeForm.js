  ...
  return (
    <>
      <div className='text-center block back'>
        ...
        <input placeholder='Put code: Candy' ref={code} id='font' className='sm:w-96 w-64 sm:mr-12 sm:ml-12 text-center outline-0 pr-5 pl-5 rounded-xl border-8 border-yellow-400 hover:bg-yellow-700 transition ease-in delay-150 hover:scale-110 duration-300 text-yellow-400 bg-yellow-600 focus:bg-yellow-700 placeholder:text-yellow-400 mt-36 h-24 text-3xl sm:text-4xl' />
